...
## Использование
Используя метод start_parsing() добавьте исполнителей для поиска в список. Поддерживается поиск как по имени, так и по URL. Примеры возможных форматов входных данных указаны в примере ниже:
